...
export default withRouteData(() => (
    <PostDiv>
        <PostArticle>
            <PostTitleH1>Exploring the Kotlin Standard Library Part 1</PostTitleH1>
            <div>
                <p>
                    Exploring the API docs and source code for a language's standard library is usually
                    illuminating and Kotlin is no different. In this series, I thought I'd look at some
                    of the highlights of the Kotlin stdlib. In Part 1, I'll be going over the default Kotlin namespace.
                </p>
                <p>
                    Both the <a href="http://jetbrains.github.com/kotlin/versions/snapshot/apidocs/index.html">API docs</a> and the <a href="https://github.com/JetBrains/kotlin/tree/master/libraries/stdlib">source code</a> for the stdlib are available on github.
                </p>
                <p>
...
`.trim()}</KotlinCode>
                <p>
                    To do something useful with the iterator, we can use some of the other methods
                    from the standard library e.g. filter, take, forEach etc. The following code will
                    print all the integers between 0 and 100 that are divisible by 3 and 5.
                    </p>
                <KotlinCode>{`
var i = 0;
...
`.trim()}</KotlinCode>
                <p>
                    All of the arrays, collections, lists and iterators share a similar set of
                    methods: all, any, appendString, contains, count, drop, dropWhile, dropWhileTo,
                    filter, filterNot, filterNotNull, filterNotNullTo, filterNotTo, filterTo, find,
                    flatMap, flatMapTo, fold, foldRight, forEach, groupBy, groupByTo, makeString,
                    map, mapTo, partition, plus, reduce, reduceRight, requireNoNulls, reverse,
                    sort, sortBy, take, takeWhile, takeWhileTo, toArray, toCollection, toLinkedList,
                    toList, toSet, toSortedList, toSortedSet.
                </p>
                <p>
